...
#define SPI_DEVICE_MODE_MASTER				(uint8)(1<<2)
...
#define SPI_FRAME_FORMAT_LSB				(uint8)(1<<7)
...
#define SPI_CLK_POLARITY_HIGH_IDLE			(uint8)(1<<1)

//SPI_clockPhase_define
#define SPI_CLK_PHASE_EDGE1					(uint8)(0)
#define SPI_CLK_PHASE_EDGE2					(uint8)(1<<0)

//SPI_NSS_define
#define SPI_NSS_SW_SLAVE					(uint16)(1<<9)
...
#define SPI_BAUDRATE_PRESCALER_2			(uint8)(0b000<<3)
#define SPI_BAUDRATE_PRESCALER_4			(uint8)(0b001<<3)
#define SPI_BAUDRATE_PRESCALER_8			(uint8)(0b010<<3)
#define SPI_BAUDRATE_PRESCALER_16			(uint8)(0b011<<3)
#define SPI_BAUDRATE_PRESCALER_32			(uint8)(0b100<<3)
#define SPI_BAUDRATE_PRESCALER_64			(uint8)(0b101<<3)
#define SPI_BAUDRATE_PRESCALER_128			(uint8)(0b110<<3)
#define SPI_BAUDRATE_PRESCALER_256			(uint8)(0b111<<3)

//SPI_IRQ_Enable_define
#define SPI_IRQ_ENABLE_NONE					(uint8)(0)
#define SPI_IRQ_ENABLE_TXEIE				(uint8)(1<<7)
#define SPI_IRQ_ENABLE_RXNEIE				(uint8)(1<<6)
#define SPI_IRQ_ENABLE_ERRIE				(uint8)(1<<5)
